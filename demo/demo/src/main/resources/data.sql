...
INSERT INTO TEACHER (FIRST_NAME, LAST_NAME, EMAIL, PASSWORD) VALUES ('Andreas', 'Olsson', 'olsson@mail.com', '123');
INSERT INTO TEACHER (FIRST_NAME, LAST_NAME, EMAIL, PASSWORD) VALUES ('Oscar', 'Olsson', 'Oscar.olsson@mail.com', '123');

INSERT INTO TEACHER_ANNOUNCEMENT (TITLE, CONTENT, TEACHER_NAME) VALUES ('FIRST CEMENT','Hejsan hoppsan', (SELECT ID FROM TEACHER WHERE FIRST_NAME = 'Andreas'));
INSERT INTO TEACHER_ANNOUNCEMENT (TITLE, CONTENT, TEACHER_NAME) VALUES ('Second CEMENT','Hejdå san hoppsan', (SELECT ID FROM TEACHER WHERE FIRST_NAME = 'Oscar'));